...
def get_data(file, filters='!"%;[\\]^_`{|}~\t\n', training_len=100,
    ...
    abstracts = [format_sequence(a) for a in file]
...
def make_sequences(texts, training_length = 100,
